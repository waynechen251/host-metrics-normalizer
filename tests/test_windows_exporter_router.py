...
NOT_WINDOWS = DetectedExporter(type="node_exporter", os_family="linux", version="1.10.2")
...
def test_wrong_exporter_type_returns_unsupported_snapshot():
    ...
    snapshot = normalize_exporter_metrics(config, NOT_WINDOWS, raw, now=1784049820.304)
